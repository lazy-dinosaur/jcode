...
- TUI picker 의 context/thinking cycle UI (future provider-profile UI milestone, not M48).
- Gemini thinking_budget 정수 표현 (future provider-dimension milestone, not M49).
- 새 provider 추가 시 declarative mapping table (future provider-routing milestone).
...
| C-2 effort via provider | `patch/m47-c2-effort-apply-via-provider` | ✅ Done | 7256f127 | 7256f127 (+3f686b13 docs) | 14 tool::task + DeepSeek/GLM/Kimi 케이스 통과 |
| C-3 schema 확장 | `patch/m47-c3-route-config-context-thinking` | ✅ Done | 0865781c | 0865781c | 6 new + 15 agent_profiles_md + 54 config + 14 tool::task pass |
| C-4 provider trait | `patch/m47-c4-provider-trait-dimensions` | ✅ Done | 2781d68a..d367dbdb | 963dc57e | 470/471 provider:: + 55 anthropic + 5 new |
| C-5 variant resolver | `patch/m47-c5-variant-resolver` | ✅ Done | 18b73c8b | 18b73c8b | 21 tool::task (4-provider matrix) + 15 agent_profiles_md + 54 config pass |
| C-6 session | `patch/m47-c6-session-preferences` | ✅ Done | 533431e9 | 533431e9 (+eb4d17bc merge) | 3 new round-trip + 46 agent:: + 97 session:: pass |
| C-7 config defaults | `patch/m47-c7-provider-config-defaults` | ✅ Done | 99ecbda7 | 99ecbda7 | 2 new + 56 config + 21 tool::task pass |
| C-8 doctor | `patch/m47-c8-doctor-effective-dimensions` | ✅ Done | fa1acf52 | fa1acf52 | 11 doctor_tests pass (1 new) |
| C-9 samples + docs | `patch/m47-c9-sample-agent-md` | ✅ Done | 6784854a | 6784854a | 4 project_init tests + 2 new (samples assertions) pass |
