...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            last_message_received_hook_message_id: None,
            ...
            last_stream_redraw_request: None,
            ...
            manual_tool_cancel_signal: None,
            manual_tool_background_signal: None,
            ...
            split_view_rendered_streaming_version: 0,
