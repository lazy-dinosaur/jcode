...
const REGISTERED_COMMANDS: &[RegisteredCommand] = &[
    ...
    RegisteredCommand::public("/nvim", "Open nvim in an embedded scratchpad"),
    RegisteredCommand::public("/scratchpad", "Toggle the active terminal scratchpad"),
    RegisteredCommand::public("/sp", "Alias for /scratchpad"),
