...
fn test_normalize_ratio_treats_low_integer_values_as_percent() {
    assert_eq!(openai_helpers::normalize_ratio_value(0.0), 0.0);
    assert_eq!(openai_helpers::normalize_ratio_value(1.0), 0.01);
    assert_eq!(openai_helpers::normalize_ratio_value(5.0), 0.05);
    assert_eq!(openai_helpers::normalize_ratio_value(50.0), 0.5);
    assert_eq!(openai_helpers::normalize_ratio_value(100.0), 1.0);
    assert_eq!(openai_helpers::normalize_ratio_value(150.0), 1.0);
    assert_eq!(openai_helpers::normalize_ratio_value(-10.0), 0.0);
    assert_eq!(openai_helpers::normalize_ratio_value(f32::NAN), 0.0);
}
